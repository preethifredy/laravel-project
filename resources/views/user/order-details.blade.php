        ...
        <div class="col-lg-10">
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    <div class="row">
                        <div class="col-6"> <h5> Ordered Details</h5></div>
                        <div class="col-6 text-right" ><a class="btn btn-sm btn-danger" href="{{route('user.account.orders')}}">Back</a></div>
                    </div>
                </div>
            ...
            <div class="wg-box">
                <div class="flex items-center justify-between gap10 flex-wrap">
                    ...
                    <div class="row">
                        <div class="col-6"> <h5> Ordered Items</h5></div>
