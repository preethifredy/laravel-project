                    ...
                    <div class="upload-image flex-grow">
                        @if($product->image)
                            <div class="item" id="imgpreview" >
                                <img src="{{asset('uploads/products')}}/{{trim($product->image)}}"
                                    class="effect8" alt="">
                            </div>
                        @endif
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="stock_status">
                                <option value="instock" {{$product->stock_status==
                                "instock" ? "selected" : ""}} >InStock</option>
                                <option value="outofstock" {{$product->stock_status==
                    ...
                    <fieldset class="name">
                        ...
                        <div class="select mb-10">
                            <select class="" name="featured">
                                <option value="0" {{$product->featured==
                                0 ? "selected" : ""}}>No</option>
                                <option value="1" {{$product->featured==
